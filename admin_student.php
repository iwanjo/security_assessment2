...
<ul>
  ...
  <li><a class="active" href="admin_student.php">Students</a></li>
  ...
  <div class="container">
    <div class="panel panel-default">
      <div class="panel-heading">
        ...
        <div class="row">
		  	  <a href="add_student.php"><button class="btn btn-success col-lg-3 col-md-4 col-sm-11 col-xs-11 button" style="margin-left: 15px;margin-bottom: 5px"><span class="glyphicon glyphicon-plus-sign"></span>Add Student</button></a>
			  <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 pull-right">
			  	<form method="post" action="admin_student.php" enctype="multipart/form-data">
      ...
      <table class="table table-bordered">
        ...
        if (isset($_POST['search'])) {
          ...
          if (mysqli_num_rows($query)==0) {
            echo "Sorry. Student information unavailable. Try searching again!";
          }
          else {
          ...
          $sql2 ="SELECT * from user_levels where role like 'Student'";
  ...
  <script>
 function Delete() {
            return confirm('Would you like to delete the student?');
        }
</script>
