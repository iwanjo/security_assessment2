...
<ul>
  ...
  <li><a class="active" href="admin_faculty.php">Faculty</a></li>
      ...
      <div class="panel-heading">
        <?php if(isset($error) === true) { ?>
          <div class="alert alert-success alert-dismissable">
            ...
            <strong>Faculty Record Deleted Successfully!</strong>
          </div>
        <?php } ?>

        <div class="row">
		  	  <a href="add_faculty.php"><button class="btn btn-success col-lg-3 col-md-4 col-sm-11 col-xs-11 button" style="margin-left: 15px;margin-bottom: 5px"><span class="glyphicon glyphicon-plus-sign"></span>Add Faculty</button></a>
			  <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 pull-right">
			  	<form method="post" action="admin_faculty.php" enctype="multipart/form-data">
      ...
      <table class="table table-bordered">
        ...
        if (isset($_POST['search'])) {
          ...
          if (mysqli_num_rows($query)==0) {
            echo "Sorry. Faculty information unavailable. Try searching again!";
          }
          else {
          ...
          $sql2 ="SELECT * from user_levels where role like 'Faculty'";
  ...
  <script>
 function Delete() {
            return confirm('Would you like to delete the faculty?');
        }
</script>
